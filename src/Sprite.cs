...
public class Sprite {
	...
	public static Texture[] xArmorBootsBitmap = new Texture[6];
	public static Texture[] xArmorBodyBitmap = new Texture[6];
	public static Texture[] xArmorHelmetBitmap = new Texture[6];
	public static Texture[] xArmorArmBitmap = new Texture[6];
